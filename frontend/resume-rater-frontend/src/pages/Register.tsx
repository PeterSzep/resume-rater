        ...
        <div className="z-10 w-full max-w-md">
          ...
          <div className="glass-card rounded-2xl p-7 shadow-2xl">
            ...
            <p className="text-alice-blue/90 text-base leading-relaxed font-medium">
              Analyze your resume, identify skill gaps, and optimize for ATS to
              ensure you land more interviews and secure your dream job faster
              than ever before.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-50 dark:bg-slate-900/50 border rounded-xl py-2.5 pl-12 pr-4 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all placeholder:text-slate-400 ${errors.name ? "border-red-400" : "border-slate-200 dark:border-slate-800"}`}
                />
              </div>
              {errors.name && (
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (errors.retypePassword) setErrors((prev) => ({ ...prev, retypePassword: undefined }));
                    }}
                    className={`w-full bg-slate-50 dark:bg-slate-900/50 border rounded-xl py-2.5 pl-12 pr-4 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all placeholder:text-slate-400 ${errors.retypePassword ? "border-red-400" : "border-slate-200 dark:border-slate-800"}`}
                  />
                </div>
